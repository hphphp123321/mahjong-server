...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Logs = userManyToManyLogs{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Logs", "entity.Log"),
		Users: struct {
			field.RelationField
			Logs struct {
				field.RelationField
			...
			RelationField: field.NewRelation("Logs.Users", "entity.User"),
			Logs: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Logs.Users.Logs", "entity.Log"),
			},
		},
	}
...
type userManyToManyLogs struct {
	db *gorm.DB
...
func (a userManyToManyLogs) Where(conds ...field.Expr) *userManyToManyLogs {
	if len(conds) == 0 {
		return &a
	}
...
func (a userManyToManyLogs) WithContext(ctx context.Context) *userManyToManyLogs {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a userManyToManyLogs) Session(session *gorm.Session) *userManyToManyLogs {
	a.db = a.db.Session(session)
	return &a
}

func (a userManyToManyLogs) Model(m *entity.User) *userManyToManyLogsTx {
	return &userManyToManyLogsTx{a.db.Model(m).Association(a.Name())}
}

type userManyToManyLogsTx struct{ tx *gorm.Association }

func (a userManyToManyLogsTx) Find() (result []*entity.Log, err error) {
	return result, a.tx.Find(&result)
}

func (a userManyToManyLogsTx) Append(values ...*entity.Log) (err error) {
...
func (a userManyToManyLogsTx) Replace(values ...*entity.Log) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userManyToManyLogsTx) Delete(values ...*entity.Log) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userManyToManyLogsTx) Clear() error {
	return a.tx.Clear()
}

func (a userManyToManyLogsTx) Count() int64 {
	return a.tx.Count()
}
