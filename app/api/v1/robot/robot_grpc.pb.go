...
type GrpcRobotClient interface {
	...
	ChooseActionByJSON(ctx context.Context, in *JsonMessage, opts ...grpc.CallOption) (*ChooseActionReply, error)
}
...
func (c *grpcRobotClient) ChooseActionByJSON(ctx context.Context, in *JsonMessage, opts ...grpc.CallOption) (*ChooseActionReply, error) {
	out := new(ChooseActionReply)
	err := c.cc.Invoke(ctx, "/grpcRobot.GrpcRobot/ChooseActionByJSON", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GrpcRobotServer interface {
	...
	ChooseActionByJSON(context.Context, *JsonMessage) (*ChooseActionReply, error)
...
func (UnimplementedGrpcRobotServer) ChooseActionByJSON(context.Context, *JsonMessage) (*ChooseActionReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChooseActionByJSON not implemented")
}
...
func _GrpcRobot_ChooseActionByJSON_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(JsonMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GrpcRobotServer).ChooseActionByJSON(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpcRobot.GrpcRobot/ChooseActionByJSON",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GrpcRobotServer).ChooseActionByJSON(ctx, req.(*JsonMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GrpcRobot_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChooseActionByJSON",
			Handler:    _GrpcRobot_ChooseActionByJSON_Handler,
		},
	},
