...
type MahjongClient interface {
	...
	RegisterRobot(ctx context.Context, in *RegisterRobotRequest, opts ...grpc.CallOption) (*RegisterRobotReply, error)
	UnregisterRobot(ctx context.Context, in *UnregisterRobotRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *mahjongClient) Ping(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/mahjong_pb.Mahjong/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mahjongClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginReply, error) {
	out := new(LoginReply)
	err := c.cc.Invoke(ctx, "/mahjong_pb.Mahjong/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mahjongClient) Logout(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*LogoutReply, error) {
	out := new(LogoutReply)
	err := c.cc.Invoke(ctx, "/mahjong_pb.Mahjong/Logout", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mahjongClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterReply, error) {
	out := new(RegisterReply)
	err := c.cc.Invoke(ctx, "/mahjong_pb.Mahjong/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mahjongClient) CreateRoom(ctx context.Context, in *CreateRoomRequest, opts ...grpc.CallOption) (*CreateRoomReply, error) {
	...
	err := c.cc.Invoke(ctx, "/mahjong_pb.Mahjong/CreateRoom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mahjongClient) JoinRoom(ctx context.Context, in *JoinRoomRequest, opts ...grpc.CallOption) (*JoinRoomReply, error) {
	...
	err := c.cc.Invoke(ctx, "/mahjong_pb.Mahjong/JoinRoom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mahjongClient) ListRooms(ctx context.Context, in *ListRoomsRequest, opts ...grpc.CallOption) (*ListRoomsReply, error) {
	...
	err := c.cc.Invoke(ctx, "/mahjong_pb.Mahjong/ListRooms", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mahjongClient) ListRobots(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListRobotsReply, error) {
	...
	err := c.cc.Invoke(ctx, "/mahjong_pb.Mahjong/ListRobots", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mahjongClient) RegisterRobot(ctx context.Context, in *RegisterRobotRequest, opts ...grpc.CallOption) (*RegisterRobotReply, error) {
	out := new(RegisterRobotReply)
	err := c.cc.Invoke(ctx, "/mahjong_pb.Mahjong/RegisterRobot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mahjongClient) UnregisterRobot(ctx context.Context, in *UnregisterRobotRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/mahjong_pb.Mahjong/UnregisterRobot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mahjongClient) Ready(ctx context.Context, opts ...grpc.CallOption) (Mahjong_ReadyClient, error) {
	stream, err := c.cc.NewStream(ctx, &Mahjong_ServiceDesc.Streams[0], "/mahjong_pb.Mahjong/Ready", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *mahjongClient) Game(ctx context.Context, opts ...grpc.CallOption) (Mahjong_GameClient, error) {
	stream, err := c.cc.NewStream(ctx, &Mahjong_ServiceDesc.Streams[1], "/mahjong_pb.Mahjong/Game", opts...)
	if err != nil {
		return nil, err
	}
...
type MahjongServer interface {
	...
	RegisterRobot(context.Context, *RegisterRobotRequest) (*RegisterRobotReply, error)
	UnregisterRobot(context.Context, *UnregisterRobotRequest) (*Empty, error)
...
func (UnimplementedMahjongServer) Register(context.Context, *RegisterRequest) (*RegisterReply, error) {
...
func (UnimplementedMahjongServer) RegisterRobot(context.Context, *RegisterRobotRequest) (*RegisterRobotReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterRobot not implemented")
}
func (UnimplementedMahjongServer) UnregisterRobot(context.Context, *UnregisterRobotRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnregisterRobot not implemented")
}
...
func _Mahjong_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mahjong_pb.Mahjong/Ping",
	}
...
func _Mahjong_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mahjong_pb.Mahjong/Login",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Mahjong_Logout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mahjong_pb.Mahjong/Logout",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Mahjong_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MahjongServer).Register(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mahjong_pb.Mahjong/Register",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MahjongServer).Register(ctx, req.(*RegisterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Mahjong_CreateRoom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mahjong_pb.Mahjong/CreateRoom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Mahjong_JoinRoom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mahjong_pb.Mahjong/JoinRoom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Mahjong_ListRooms_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mahjong_pb.Mahjong/ListRooms",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Mahjong_ListRobots_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mahjong_pb.Mahjong/ListRobots",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Mahjong_RegisterRobot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterRobotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MahjongServer).RegisterRobot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mahjong_pb.Mahjong/RegisterRobot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MahjongServer).RegisterRobot(ctx, req.(*RegisterRobotRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Mahjong_UnregisterRobot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnregisterRobotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MahjongServer).UnregisterRobot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mahjong_pb.Mahjong/UnregisterRobot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MahjongServer).UnregisterRobot(ctx, req.(*UnregisterRobotRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Mahjong_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mahjong_pb.Mahjong",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Register",
			Handler:    _Mahjong_Register_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _Mahjong_RegisterRobot_Handler,
		},
		{
			MethodName: "UnregisterRobot",
			Handler:    _Mahjong_UnregisterRobot_Handler,
		},
	},
	...
	Metadata: "app/api/v1/mahjong/mahjong.proto",
}
